    ...
    <header className="bg-card border-b border-border px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2 sm:space-x-4 flex-1 min-w-0">
          <Button variant="ghost" size="sm" onClick={handleMenuClick} className="h-9 w-9 p-0 shrink-0">
            <Menu className="h-4 w-4" />
          </Button>

          <div className="min-w-0 flex-1">
            <h2 className="text-base sm:text-lg font-semibold text-foreground truncate">
              {isMobile ? "Sistema SST" : "Bem-vindo ao Sistema SST"}
            </h2>
            {!isMobile && (
        ...
        <div className="hidden md:flex flex-1 justify-center max-w-xs lg:max-w-md mx-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-48 sm:w-56" align="end" forceMount>
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium leading-none">Admin SST</p>
